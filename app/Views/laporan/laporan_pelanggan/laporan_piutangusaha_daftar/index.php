...
<title>Akuntansi Eureeka &mdash; Laporan Daftar Piutang Usaha</title>
<?= $this->endSection(); ?>
  ...
  <div class="card">
    <div class="card-header">
      <div class="card-header-action">
        <a href="<?= base_url('laporandaftarpiutangusaha/printPDF?tglawal=' . $tglawal . '&tglakhir=' . $tglakhir) ?>" class="btn btn-success" target="_blank">
          <i class="fas fa-print"></i> Cetak PDF
        </a>
      </div>
    </div>
    <div class="card-body">
      <form method="GET" action="<?= base_url('laporandaftarpiutangusaha') ?>">
        <div class="row">
          <div class="col-md-3">
