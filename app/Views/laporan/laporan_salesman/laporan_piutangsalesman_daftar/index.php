...
<title>Akuntansi Eureeka &mdash; Laporan Daftar Piutang Salesman</title>
<?= $this->endSection(); ?>
...
<section class="section">
  <div class="section-header">
    <h1>Daftar Piutang Salesman</h1>
  </div>

  <div class="card">
    <div class="card-header">
      <div class="card-header-action">
        <a href="<?= base_url('laporandaftarpiutangsalesman/printPDF?tglawal=' . $tglawal . '&tglakhir=' . $tglakhir) ?>" class="btn btn-success" target="_blank">
          <i class="fas fa-print"></i> Cetak PDF
        </a>
      </div>
    </div>
    <div class="card-body">
      <form method="GET" action="<?= base_url('laporandaftarpiutangsalesman') ?>">
        <div class="row">
          <div class="col-md-3">
