...
<title>Akuntansi Eureeka &mdash; Laporan Kartu Piutang Salesman</title>
<?= $this->endSection(); ?>
  ...
  <div class="card">
    <div class="card-header">
      <div class="card-header-action">
        <a href="<?= base_url('laporankartupiutangsalesman/printPDF?tglawal=' . $tglawal . '&tglakhir=' . $tglakhir . '&salesman=' . $salesman) ?>" class="btn btn-success" target="_blank">
          <i class="fas fa-print"></i> Cetak PDF
        </a>
      </div>
    </div>
    <div class="card-body">
      <form method="GET" action="<?= base_url('laporankartupiutangsalesman') ?>">
        <div class="row">
          <div class="col-md-3">
