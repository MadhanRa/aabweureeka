...
<title>Akuntansi Eureeka &mdash; Laporan Penjualan Per Pelanggan (Tahun)</title>
<?= $this->endSection(); ?>
...
<section class="section">
  <div class="section-header">
    <h1>Laporan Penjualan Per Pelanggan (Tahun)</h1>
  </div>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <form method="GET" action="<?= base_url('laporanpenjualan_ppt') ?>">
        <div class="row">
          <div class="col-md-3">
        ...
        <table class="table table-striped table-md display nowrap compact eureeka-table" id="myTable">
          ...
          <tfoot>
            <tr>
              ...
              <th colspan="12" style="text-align: right;">Total Tahun Ini:</th>
