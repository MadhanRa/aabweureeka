...
<head>
  ...
  <link rel="stylesheet"
    href="<?= base_url('template/node_modules/datatables.net-select-bs4/css/select.bootstrap4.min.css') ?>">
  <!-- CSS Libraries -->
  ...
  <link rel="stylesheet" href="<?= base_url('template/assets/css/custom.v2.css') ?>">
      ...
      <footer class="main-footer">
        <div class="footer-left">
          Copyright &copy; 2024 <div class="bullet"></div> Design By <a
            href="https://eureekagreatnusantara.com/">Eureeka Great Nusantara</a>
        </div>
