...
<title>Akuntansi Eureeka &mdash; Laporan Daftar Hutang</title>
<?= $this->endSection(); ?>
...
<section class="section">
  <div class="section-header">
    <h1>Daftar Hutang Supplier</h1>
  </div>

  <div class="card">
    <div class="card-header">
      <div class="card-header-action">
        <a href="<?= base_url('laporandaftarhutangsupplier/printPDF?tglawal=' . $tglawal . '&tglakhir=' . $tglakhir) ?>" class="btn btn-success" target="_blank">
          <i class="fas fa-print"></i> Cetak PDF
        </a>
      </div>
    </div>
    <div class="card-body">
      <form method="GET" action="<?= base_url('laporandaftarhutangsupplier') ?>">
        <div class="row">
          <div class="col-md-3">
