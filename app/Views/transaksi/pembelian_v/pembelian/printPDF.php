...
<head>
    ...
    <style>
        ...
        .flex-container>div {
            width: 45%;
            /* Atur lebar elemen agar pas di dalam satu baris */
        }
...
<body>
    ...
    <table class="table-summary">
        <tr>
            ...
            <td rowspan="4" class="text-center">Gudang: <?= htmlspecialchars(isset($dtpembelian->nama_lokasi) ? $dtpembelian->nama_lokasi : '-') ?></td>
            <td>Sub.Total</td>
