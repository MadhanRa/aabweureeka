    ...
    <div class="card">
      <div class="card-header">
        ...
        <div class="card-header-action">
          <!-- <a href="<?= base_url('transaksi/penjualan/penjualan/printPDF') ?>" class="btn btn-success" target="_blank">
                ...
                <?php foreach ($dtpenjualan as $key => $value) : ?>
                  <tr>
                    ...
                    <td class="text-center">
                      ...
                      <?php else: ?>
                        <!-- Tombol Edit Data -->
                        <a href="<?= site_url('transaksi/penjualan/penjualan/' . $value->id_penjualan) .  '/edit' ?>" class="btn btn-warning"><i class="fas fa-pencil-alt btn-small"></i> Edit</a>
                        <input type="hidden" name="_method" value="PUT">

                        <!-- Tombol Hapus Data -->
                        <!-- <form action="<?= site_url('transaksi/penjualan/penjualan/' . $value->id_penjualan) ?>" method="post" id="del-<?= $value->id_penjualan ?>" class="d-inline">
                          <?= csrf_field() ?>
                      ...
                      <?php endif ?>
                      <!-- Tombol Print Data -->
                      <a href="<?= base_url('transaksi/penjualan/penjualan/printPDF/' . $value->id_penjualan) ?>" class="btn btn-success btn-small" target="_blank">
