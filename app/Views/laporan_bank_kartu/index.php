...
<title>Akuntansi Eureeka &mdash; Laporan Kartu Bank</title>
<?= $this->endSection(); ?>
  ...
  <div class="card">
    <div class="card-header">
      <div class="card-header-action">
        <a href="<?= base_url('laporanbankkartu/printPDF?tglawal=' . $tglawal . '&tglakhir=' . $tglakhir . '&bank=' . $bank) ?>" class="btn btn-success" target="_blank">
          <i class="fas fa-print"></i> Cetak PDF
        </a>
      </div>
    </div>
    <div class="card-body">
      <form method="GET" action="<?= base_url('laporanbankkartu') ?>">
        <div class="row">
          <div class="col-md-3">
