...
<title>Akuntansi Eureeka &mdash; Laporan Daftar Stock Akhir Minimal</title>
<?= $this->endSection(); ?>
...
<section class="section">
  <div class="section-header">
    <h1>Daftar Stock Akhir Minimal</h1>
  </div>

  <div class="card">
    <div class="card-header">
      <div class="card-header-action">
        <a href="<?= base_url('laporandaftarstock_minimal/printPDF?tglawal=' . $tglawal . '&tglakhir=' . $tglakhir . '&kelompok=' . $kelompok . '&group=' . $group . '&lokasi=' . $lokasi . '&supplier=' . $supplier) ?>" class="btn btn-success" target="_blank">
          <i class="fas fa-print"></i> Cetak PDF
        </a>
      </div>
    </div>
    <div class="card-body">
      <form method="GET" action="<?= base_url('laporandaftarstock_minimal') ?>">
        <div class="row">
          <div class="col-md-3">
