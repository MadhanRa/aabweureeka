...
<title>Akuntansi Eureeka &mdash; Laporan Penjualan P3 Tahun</title>
<?= $this->endSection(); ?>
...
<section class="section">
  <div class="section-header">
    <h1>Laporan Penjualan Per Salesman Per Pelanggan Per Barang (Tahun)</h1>
  </div>
  ...
  <div class="card">
    <div class="card-header">
      <div class="card-header-action">
        <a href="<?= base_url('laporanpenjualan_pt/printPDF?tahun=' . $tahun . '&salesman=' . $salesman . '&lokasi=' . $lokasi . '&pelanggan=' . $pelanggan . '&supplier=' . $supplier . '&view_option=' . $view_option) ?>" class="btn btn-success" target="_blank">
          <i class="fas fa-print"></i> Cetak PDF
        </a>
      </div>
    </div>
    <div class="card-body">
      <form method="GET" action="<?= base_url('laporanpenjualan_pt') ?>">
        <div class="row">
          <div class="col-md-3">
