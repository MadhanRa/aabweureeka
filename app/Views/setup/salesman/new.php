                ...
                <div class="form-container">
                    <form method="post" action="<?= site_url('setup/salesman') ?> ">
                        ...
                        <div class="form-group">
                            <label>Kode</label>
                            <input type="text" class="form-control" name="kode_setupsalesman" placeholder="Kode" value="<?= $kode_setupsalesman ?>" readonly>
                        </div>
                        ...
                        <div class="form-group">
                            <label>Lokasi</label>
                            <select type="text" class="form-control" name="id_lokasi" placeholder="Lokasi" required>
