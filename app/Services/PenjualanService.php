...
class PenjualanService
{
    ...
    {
        log_message('info', 'Creating new penjualan header with data: ' . json_encode($data));
    ...
    protected function saveDetails(int $idPenjualan, array $newDetails, array $headerData)
    {
        ...
        foreach ($newDetails as $detail) {
            ...
            log_message('info', 'Processing detail penjualan: ' . json_encode($detailPenjualan->getRecords()));
