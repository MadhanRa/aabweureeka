...
class LaporanStockOpname extends BaseController
{
    ...
    public function index()
    {
        ...
        $daftar_stock_opname = $this->modelStockOpname->get_laporan($tglawal, $tglakhir, $lokasi, $user);


        // Ambil data tambahan untuk dropdown filter
        $data = [
            'dtdaftar_stock_opname'    => $daftar_stock_opname,
            'tglawal'        => $tglawal,
            'tglakhir'       => $tglakhir,
            'lokasi'       => $lokasi,
        ...
        return view('laporan_stockopname/index', $data);
    }
