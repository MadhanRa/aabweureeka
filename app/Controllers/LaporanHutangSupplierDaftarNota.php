...
class LaporanHutangSupplierDaftarNota extends BaseController
{
    ...
    function __construct()
    {
        ...
        $this->objPenjualan = new ModelPembelian();
    ...
    public function index()
    {
        ...
        $riwayat_hutang = $this->objRiwayatHutang->get_laporan_daftar_nota($tglawal, $tglakhir);
        $riwayat_hutang_summary = $this->objRiwayatHutang->get_laporan_summary_daftar_nota($tglawal, $tglakhir);

        // cek data
        log_message('info', 'Riwayat Piutang: ' . print_r($riwayat_hutang, true));
        log_message('info', 'Riwayat Piutang Summary: ' . print_r($riwayat_hutang_summary, true));
