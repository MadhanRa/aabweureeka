...
class LaporanBukuBesar extends BaseController
{
    ...
    public function index()
    {
        ...
        $data = [
            ...
            'dtsetup_buku'         => $this->modelSetupBuku->getAll(),
        ];

        return view('laporan_keuangan/laporan_buku_besar/index', $data);
    }
