...
class LaporanPenjualanPTB extends BaseController
{
    protected $objLokasi;
    ...
    public function index()
    {
        ...
        $penjualan = $this->objPenjualan->get_laporan_ptb($tahun, $salesman, $lokasi, $supplier, $stock, $pelanggan, $view_option);
        ...
        return view('laporanpenjualan_ptb/index', $data);
    }
