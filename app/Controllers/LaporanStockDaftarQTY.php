...
class LaporanStockDaftarQTY extends BaseController
{
    ...
    public function index()
    {
        ...
        $riwayat_mutasi = $this->modelMutasi->get_laporan_daftar_q($tglawal, $tglakhir, $kelompok, $group, $lokasi, $supplier);
        $riwayat_mutasi_summary = $this->modelMutasi->get_laporan_daftar_summary_q($tglawal, $tglakhir, $kelompok, $group, $lokasi, $supplier);
        $riwayat_mutasi_total = $this->modelMutasi->get_laporan_daftar_total_q($kelompok, $group, $lokasi, $supplier);
        ...
        return view('laporan_stock_daftar_qty/index', $data);
    }
