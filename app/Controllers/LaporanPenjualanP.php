...
class LaporanPenjualanP extends BaseController
{
    ...
    public function index()
    {
        ...
        $penjualan = $this->objPenjualan->get_laporan_p3($tglawal, $tglakhir, $salesman, $lokasi, $supplier, $stock, $pelanggan);

        $penjualan_summary = $this->objPenjualan->get_laporan_summary_p($tglawal, $tglakhir, $salesman, $lokasi, $supplier, $stock, $pelanggan);
